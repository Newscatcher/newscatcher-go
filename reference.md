# Reference
## Search
<details><summary><code>client.Search.Get() -> *v505.GetSearchResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.Search.Post(request) -> *v505.PostSearchResponse</code></summary>
<dl>
<dd>
...
```go
request := &v505.PostSearchRequest{
        Q: `"supply chain" AND Amazon NOT China`,
        PageSize: v505.Int(
            1,
        ),
...
## LatestHeadlines
<details><summary><code>client.LatestHeadlines.Get() -> *v505.GetLatestHeadlinesResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.LatestHeadlines.Post(request) -> *v505.PostLatestHeadlinesResponse</code></summary>
<dl>
<dd>
...
## BreakingNews
<details><summary><code>client.BreakingNews.Get() -> *v505.BreakingNewsResponseDto</code></summary>
<dl>
<dd>
...
```go
request := &v505.GetBreakingNewsRequest{
        RankedOnly: v505.Bool(
            true,
        ),
        FromRank: v505.Int(
...
<details><summary><code>client.BreakingNews.Post(request) -> *v505.BreakingNewsResponseDto</code></summary>
<dl>
<dd>
...
```go
request := &v505.PostBreakingNewsRequest{
...
## Authors
<details><summary><code>client.Authors.Get() -> *v505.GetAuthorsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.Authors.Post(request) -> *v505.PostAuthorsResponse</code></summary>
<dl>
<dd>
...
## SearchByLink
<details><summary><code>client.SearchByLink.Get() -> *v505.SearchResponseDto</code></summary>
<dl>
<dd>
...
<details><summary><code>client.SearchByLink.Post(request) -> *v505.SearchResponseDto</code></summary>
<dl>
<dd>
...
```go
request := &v505.GetSourcesRequest{
        Lang: v505.String(
            "en,es",
        ),
        Countries: v505.String(
...
```go
request := &v505.PostSourcesRequest{
        PredefinedSources: &v505.PredefinedSources{
            String: "top 10 US",
        },
    }
...
## AggregationCount
<details><summary><code>client.AggregationCount.Get() -> *v505.GetAggregationCountResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.AggregationCount.Post(request) -> *v505.PostAggregationCountResponse</code></summary>
<dl>
<dd>
