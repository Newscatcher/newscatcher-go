...
var (
	nlpDataEntityFieldTranslationSummary = big.NewInt(1 << 0)
...
type NlpDataEntity struct {
	...
	TranslationSummary *string `json:"translation_summary,omitempty" url:"translation_summary,omitempty"`
...
func (n *NlpDataEntity) GetTranslationSummary() *string {
	if n == nil {
		return nil
	}
	return n.TranslationSummary
}
...
// SetTranslationSummary sets the TranslationSummary field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (n *NlpDataEntity) SetTranslationSummary(translationSummary *string) {
	n.TranslationSummary = translationSummary
	n.require(nlpDataEntityFieldTranslationSummary)
}
