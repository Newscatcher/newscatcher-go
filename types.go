...
var (
	...
	nlpDataEntityFieldNerPer             = big.NewInt(1 << 5)
	nlpDataEntityFieldNerOrg             = big.NewInt(1 << 6)
	nlpDataEntityFieldNerMisc            = big.NewInt(1 << 7)
	nlpDataEntityFieldNerLoc             = big.NewInt(1 << 8)
	nlpDataEntityFieldTranslationNerPer  = big.NewInt(1 << 9)
	nlpDataEntityFieldTranslationNerOrg  = big.NewInt(1 << 10)
	nlpDataEntityFieldTranslationNerMisc = big.NewInt(1 << 11)
	nlpDataEntityFieldTranslationNerLoc  = big.NewInt(1 << 12)
	nlpDataEntityFieldIptcTagsName       = big.NewInt(1 << 13)
	nlpDataEntityFieldIptcTagsId         = big.NewInt(1 << 14)
	nlpDataEntityFieldIabTagsName        = big.NewInt(1 << 15)
)
