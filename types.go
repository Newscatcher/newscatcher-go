...
var (
	...
	articleEntityFieldCanonicalUrl           = big.NewInt(1 << 10)
	articleEntityFieldDomainUrl              = big.NewInt(1 << 11)
	articleEntityFieldFullDomainUrl          = big.NewInt(1 << 12)
	articleEntityFieldNameSource             = big.NewInt(1 << 13)
	articleEntityFieldIsHeadline             = big.NewInt(1 << 14)
	articleEntityFieldPaidContent            = big.NewInt(1 << 15)
	articleEntityFieldParentUrl              = big.NewInt(1 << 16)
	articleEntityFieldCountry                = big.NewInt(1 << 17)
	articleEntityFieldRights                 = big.NewInt(1 << 18)
	articleEntityFieldRank                   = big.NewInt(1 << 19)
	articleEntityFieldMedia                  = big.NewInt(1 << 20)
	articleEntityFieldLanguage               = big.NewInt(1 << 21)
	articleEntityFieldDescription            = big.NewInt(1 << 22)
	articleEntityFieldContent                = big.NewInt(1 << 23)
	articleEntityFieldTitleTranslatedEn      = big.NewInt(1 << 24)
	articleEntityFieldContentTranslatedEn    = big.NewInt(1 << 25)
	articleEntityFieldWordCount              = big.NewInt(1 << 26)
	articleEntityFieldIsOpinion              = big.NewInt(1 << 27)
	articleEntityFieldTwitterAccount         = big.NewInt(1 << 28)
	articleEntityFieldAllLinks               = big.NewInt(1 << 29)
	articleEntityFieldAllDomainLinks         = big.NewInt(1 << 30)
...
func (a *ArticleEntity) GetCanonicalUrl() *bool {
	if a == nil {
		return nil
	}
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (a *ArticleEntity) SetCanonicalUrl(canonicalUrl *bool) {
	a.CanonicalUrl = canonicalUrl
	a.require(articleEntityFieldCanonicalUrl)
}
