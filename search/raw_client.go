...
func (r *RawClient) Get(
...
) (*core.Response[*newscatchergo.SearchGetResponse], error) {
	...
	return &core.Response[*newscatchergo.SearchGetResponse]{
...
func (r *RawClient) Post(
	...
	opts ...option.RequestOption,
) (*core.Response[*newscatchergo.SearchPostResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*newscatchergo.SearchPostResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
